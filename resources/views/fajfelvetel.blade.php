...
<div class="container">
    <div class="row">
        ...
        <div class="col-4">
            ...
            <form method="POST">
                @csrf
                <label for="faj" class="form-label">A faj meghatározása</label>
                <input type="text" class="form-control" id="faj" name="faj" placeholder="Példa: Macska" value="{{old('fajok')}}">
                @error('faj')
                            <div class="alert alert-danger">
                                {{$message}}
                            </div>
                        @enderror
                <button type="submit" class="btn btn-success">A faj mentése az adatbázisba</button>
            </form>
        </div>
        <div class="col-4"></div>
    <div class="row">
            ...
            <table class="table table-warning mt-2">
                ...
                <tbody>
                    ...
                    @foreach ($fajok as $faj)
                        ...
                        <button class="btn btn-danger" onclick="fajTorlesMegerosites({{ $egyFaj->af_id }});"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
