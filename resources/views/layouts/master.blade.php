    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        <div class="container-fluid">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./kapcsolat">Gazdit keresünk!</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./kapcsolat">Hasznos tanácsok</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./kapcsolat">Támogatási lehetőségek</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./veddkiareszed">Vedd ki a részed</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./kapcsolat">Rólunk</a>
              </li>
            <li class="nav-item">
